...
<template>
  ...
  <select
    class="h-12 px-6 py-2 w-full rounded text-gray-800 dark:text-gray-200 bg-gray-100 focus:bg-white dark:bg-gray-800 focus:dark:bg-gray-900 border-2 border-green-600 transition-all outline-none"
    v-bind="{
      ...$attrs,
      onChange,
    }"
